...
DEPENDENT_PACKAGES = {
    ...
    "torch": ">=2.0.0,<2.2",  # Major version cap, sync with common/src/autogluon/common/utils/try_import.py
    "lightning": ">=2.0.0,<2.2",  # Major version cap
    "pytorch_lightning": ">=2.0.0,<2.2",  # Major version cap, capping `lightning` does not cap `pytorch_lightning`!
